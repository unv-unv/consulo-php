...
public class PhpCreateClassAction extends CreateFileFromTemplateAction {
    public PhpCreateClassAction() {
        super(LocalizeValue.localizeTODO("Php Class"), LocalizeValue.localizeTODO("Create new Php Class"), PhpIconGroup.filetypesPhp());
    }
    ...
    protected void buildDialog(Project project, PsiDirectory psiDirectory, CreateFileFromTemplateDialog.Builder builder) {
        builder.setTitle(LocalizeValue.localizeTODO("Create New Class"))
            .addKind(LocalizeValue.localizeTODO("Class"), AllIcons.Nodes.Class, "PHP Class")
            .addKind(LocalizeValue.localizeTODO("Interface"), AllIcons.Nodes.Interface, "PHP Interface");

        if (PhpModuleExtensionUtil.getLanguageLevel(psiDirectory).isAtLeast(PhpLanguageLevel.PHP_5_4)) {
            builder.addKind(LocalizeValue.localizeTODO("Trait"), AllIcons.Nodes.Trait, "Php Trait");
        }
    }
